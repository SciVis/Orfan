 ...
 * __tags__ (required) A list of descriptive tags for the dataset. First try and use existing tags before adding new ones.
 ...
 * __software__ A list of software that can be used to open the dataset. A special "software.json" file is located in the "data" folder that describe different softwares in more detail. In this list we just reefer to items in that file.
 ...
 * __files__ A list of the relevant files in the dataset. A item in the file list contains
    ...
    * __resolution__ resolution of the dataset if available.
    * __tags__ list of tags for the file
